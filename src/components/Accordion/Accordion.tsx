  ...
  return (
    <div className="border border-[#C8CCD0] rounded-xl">
      <button
        ...
        className={`p-4 transition-all ${isOpen ? "border-b" : "border-b-0"} duration-300 border-[#C8CCD0] rounded-b-xl flex justify-between items-center lg:text-start w-full py-4`}
      >
        {question}
      ...
      >
        <div className="p-4 text-[#5A5C5E]">{answer}</div>
      </div>
    </div>
  );
};
