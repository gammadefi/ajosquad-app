    ...
    return (
        <div className='px-3  md:px-6'>
            ...
            <div className='flex justify-between items-center'>
                <div>
                    <h3 className='text-base md:text-xl font-semibold'>Ajohome Member</h3>
                    <p className='max-w-[648px] text-[#5A5C5E]'>
                    You can view all Ajohome Member here.
                    </p>
                </div>
            ...
            <div className='lg:grid flex my-6 py-4 gap-3 overflow-x-auto grid-cols-4'>
                <InfoCard header="Ajohome Member" iconName='people' value="50" />
            ...
            <div>
                <div className='my-8 flex justify-between items-center '>
                    <h3 className='text-xl font-semibold'>Ajohome Member</h3>
