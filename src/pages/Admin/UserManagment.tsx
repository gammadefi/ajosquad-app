...
const UserManagement = () => {
    ...
    const { data: members, isLoading: isMembersLoading } = useFetchWithParams([`query-all-staffs`, {
        search: search,
        page: currentPage
    ...
    return (
        <div className='px-3  md:px-6'>
            ...
            <div className='flex justify-between flex-wrap items-center'>
                ...
                <button className='h-[44px] border mt-5 lg:mt-0 border-primary px-4 py-2 rounded' >Add Staff <span></span></button>
            ...
            <div className='lg:grid flex my-6 py-4 gap-3 overflow-x-auto grid-cols-4'>
                <InfoCard header="Total Users" isLoading={isLoading} iconName='profile-2user' value={count && count?.data?.count} />
            ...
            <div>
...

                {
                    isMembersLoading ? <PageLoader /> :
                        members && members.data?.data.length === 0 ? <TableEmpty title='No Member yet' image='/empty-states/people.png' subtitle="No member yet in any squad" /> : <Table
